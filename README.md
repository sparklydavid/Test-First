...
but not all files are image, so if the file size meet the criteria, the code will copy it then pasted as .jpg under the same location where this bat file is located.
